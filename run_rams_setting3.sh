...
FILE_NAME="t5_rams_setting3"
LOG_NAME="t5_rams_setting3"
...
####################用户需提供的数据#####################
# 模型训练、验证、测试文件
FORMAT_DATA_DIR=${TASK_DIR}/RAG_DEE/RAMS
TRAIN_DATA_PATH=${FORMAT_DATA_DIR}/prepro_train.jsonlines
DEV_DATA_PATH=${FORMAT_DATA_DIR}/prepro_dev.jsonlines
TEST_DATA_PATH=${FORMAT_DATA_DIR}/prepro_test.jsonlines
TRAIN_DEMO_PATH=${FORMAT_DATA_DIR}/train_demo.json
DEV_DEMO_PATH=${FORMAT_DATA_DIR}/val_demo.json
TEST_DEMO_PATH=${FORMAT_DATA_DIR}/test_demo.json
